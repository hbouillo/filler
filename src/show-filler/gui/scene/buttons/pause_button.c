...
/*   Updated: 2018/03/01 06:28:11 by hbouillo         ###   ########.fr       */
/*                                                                            */
/* ************************************************************************** */
...
{
	if (!(main->pause_button = sg_create_button(main->ptr)))
	...
	sg_set_flags(main->pause_button, SG_LOCK_BOTTOM |
		SG_LOCK_SIZE | SG_ALIGN_TOP);
	sg_set_button_text(main->pause_button, sg_new_gstr("Pause",
