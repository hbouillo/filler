...
/*   Updated: 2018/02/27 07:10:20 by hbouillo         ###   ########.fr       */
/*                                                                            */
/* ************************************************************************** */
...
void					begin_button(t_show *show, t_main_scene *main)
{
	...
	sg_set_flags(main->begin_button, SG_LOCK_BOTTOM | SG_LOCK_LEFT | SG_LOCK_SIZE | SG_ALIGN_TOP | SG_ALIGN_RIGHT);
	sg_set_button_text(main->begin_button, sg_new_gstr("Begin", get_resource_path(FILLER_FONT), FILLER_TOP_FONT_SIZE));
